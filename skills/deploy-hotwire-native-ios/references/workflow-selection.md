...
3. **Build machine** — local Mac, GitHub-hosted macOS, Xcode Cloud, or another controlled Mac?
4. **Rails origin** — local Development, owner Staging, owner Production, or a temporary preview deployment?
5. **Install channel** — Simulator, direct device, registered-device distribution, TestFlight, or App Store?
...
- Use a directly installed device for Developer Mode, cookies across process death, password AutoFill, camera behavior, Universal Links, and Sandbox APNs.
